...
Ly = 16; // main pipe diameter
Lx = 32; // main pipe length
...
// Create Volume -- 3D
Extrude {0, 0, 1} {
Surface{21, 23, 25, 27, 29, 31};
Layers{1};
Recombine;
}

// Define boundary surfaces
Physical Surface("wall-4") = {48, 132, 110, 154, 62};
Physical Surface("velocity-inlet-5") = {52};
Physical Surface("velocity-inlet-6") = {96};
Physical Surface("pressure-outlet-7") = {74};
Physical Surface("wall-8") = {40, 140, 84, 92, 162, 70};
Physical Surface("frontAndBackPlanes") = {53, 141, 119, 97, 163, 75, 21, 29, 27, 25, 31, 23};
